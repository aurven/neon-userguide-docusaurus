...
From the Binder, you can also edit metadata in the object panel, view correlated items, or add content to your pinboard so you can make quick metadata changes and manage your content directly from the dashboard without needing to open it in a new tab.

![Dashboard Binder](/img/userguide-screenshots/image%20170.png)

You can learn more about how to utilize Neon's Binder [here](/docs/user-guide/neons-binder).